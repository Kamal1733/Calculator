...
function Calculator() {
  ...
  return (
    ...
    <div  className="main">
         ...
         <button name="1" onClick={handelClick}  >7</button>
         <button name="2" onClick={handelClick}  >8</button>
         <button  name="3" onClick={handelClick} >9</button>
         ...
         <button name="7"  onClick={handelClick} >1</button>
         <button name="8"  onClick={handelClick} >2</button>
         <button name="9"  onClick={handelClick} >3</button>
